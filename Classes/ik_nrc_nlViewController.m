...
- (void) showIkje:(int)i {
	...
	NSString *html = [NSString stringWithFormat:@"<html><head><title></title><style type=\"text/css\">h1{background: url(\"%@\") 2px left no-repeat; border-bottom: 1px solid #d30910; padding: 0px 0px 5px 20px; margin: 10px 0px 15px 0px; font-family: Helvetica; font-size: 20px;} html{font-family: verdana; font-size: 14px;} body{margin: 0px 15px 0px 15px;} strong{display: block;text-transform: uppercase; text-align: right;}</style></head><body><h1>%@</h1>", backgroundImage, currentIkje.title];
